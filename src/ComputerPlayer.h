...
private:
	 ...
	 */
	static int get_score_after_move(const IRules& rules, const Board& board, const PlayerTypes player_type, const Point& move);
	/**
	 ...
	 */
	static Board get_board_after_move(const IRules& rules, const Board& board, const PlayerTypes player_type, const Point& move);
	/**
	 *getting the score.
	 *@param board the board.
